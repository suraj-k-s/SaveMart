...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.MyViewHolder> {
    ...
    private MyCartAdapter.QuantityUpdateListener quantityUpdateListener;
    private MyCartAdapter.ItemDeleteListener itemDeleteListener;

    public MyCartAdapter(Context ct, String name[], String price[], String image[], String id[], String qty[], MyCartAdapter.QuantityUpdateListener listener, MyCartAdapter.ItemDeleteListener deleteListener,TextView grandTotalTextView) {
        context = ct;
        Name = name;
        Price= price;
        Image = image;
    ...
    public MyCartAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.my_cart_layout, parent, false);
