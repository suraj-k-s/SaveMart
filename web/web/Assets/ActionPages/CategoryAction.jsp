...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (field_name.equals("file_category"))//write the name of image here it is img_product
                        {
                            ...
                            photo = "FIle" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                ...
                String InsQry = "insert into tbl_category(category_type,category_image) values('" + value[0] + "','" + photo + "')";
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Admin/Category.jsp'
