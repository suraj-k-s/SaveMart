...
<html lang="en" >
    ...
    {
        String up ="update tbl_booking set payment_status='1' where booking_id='"+session.getAttribute("bid")+"'";
                    ...
                    <form method="post">
                        <div class="card space icon-relative">
                         ...
                         <div class="card space icon-relative">
                            ...
                            <%
                            String sel="select * from tbl_booking where booking_id='"+session.getAttribute("bid")+"' and user_id='"+session.getAttribute("Uid")+"'";
                            ResultSet rs =con.selectCommand(sel);
                            rs.next();
                            %>
                            <input type="text" class="input" placeholder="Amount" value="<%=rs.getString("booking_amount")%>" readonly>
