<%-- 
    Document   : ReportHomeDelivery
    Created on : 11 Jul, 2023, 11:39:22 AM
    Author     : densy
--%>
...
<html>
    <head>
        ...
        <title>Admin-Report Delivery</title>
    </head>
    <body><%@include file="Header.jsp" %>
          <div id="tab" align="center">
        <h1 align="center">HOME DELIVERY ORDERS</h1>
        <form method="post">
            <table align="center">
        ...
        {
            int i=0;
        String sel="select * from tbl_booking b inner join tbl_user u on b.user_id=u.user_id where b.booking_date between '"+request.getParameter("fromdate")+"' and '"+request.getParameter("todate")+"' and delivery_mode='Home delivery'";
